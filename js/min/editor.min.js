function init() {
    map = new google.maps.Map(document.getElementById("map-holder"), {
        ...
        bindDataLayerListeners(map.data), dropContainer = document.getElementById("drop-container"),
        panel = document.getElementById("panel");
    var e = document.getElementById("map-holder");
    geoJsonInput = document.getElementById("geojson-input");
    downloadLink = document.getElementById("download-link"), resizeGeoJsonInput(), [e, dropContainer].forEach(function(e) {
...
function refreshGeoJsonFromData() {
    map.data.toGeoJson(function(e) {
        geoJsonInput.value = JSON.stringify(e.features[0].geometry.coordinates, null, 2), refreshDownloadLinkFromGeoJson()
    })
}
